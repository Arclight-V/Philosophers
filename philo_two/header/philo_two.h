...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/12/09 20:21:34 by anatashi          #+#    #+#             */
/*   Updated: 2021/01/08 15:39:18 by anatashi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
** *forks - the number of available forks is represented bya semaphore.
*/
...
** sem_t *sem_open(const char *name, int og_flag,
...
t_philo_two						*init_struct_philo(t_configuration_simulation
													*conf);
...
*/
void							checking_death_and_ntepme(t_philo_two
															*philo_two);
